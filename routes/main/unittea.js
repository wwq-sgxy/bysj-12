...
var UnitTea = tables.UnitTea;   //行政单元表模型
...
router.get('/', function(req, res) {
  ...
  UnitTea.count().then(function(total) {
...
router.get('/new', function(req, res) {
  var unit = UnitTea.build({});

  res.render('unitteas/new', {
    title: '创建教职工单元',
    sess: req.session,
    unit: unit
  });
